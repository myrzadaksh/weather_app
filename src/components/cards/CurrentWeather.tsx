    ...
    return (
        <Card title="Current Weather" className="md:pb-11" childrenClassName="flex flex-col items-center gap-6 2xl:justify-between">
            <div className="flex flex-col gap-2 items-center">
                <h2 className="text-6xl font-semibold text-center">{Math.round((data.current.temp - 32) * 5 / 9)}°C</h2>
            ...
            <div className="flex justify-between w-full">
                <div className="flex flex-col items-center gap-2">
                    ...
                    <p>{Math.round((data.current.feels_like - 32) * 5 / 9)}°C</p>
                </div>
                <div className="flex flex-col items-center gap-2">
                ...
                <div className="flex flex-col items-center gap-2">
                    ...
                    <p>{(data.current.wind_speed * 1.60934).toFixed(1)} km/h</p>
                </div>
            </div>
        </Card>
    )
